...
type PerformerLoaderConfig struct {
	...
	Fetch func(keys []string) ([]*models.Performer, []error)
...
type PerformerLoader struct {
	...
	cache map[string]*models.Performer
...
func (l *PerformerLoader) Load(key string) (*models.Performer, error) {
...
func (l *PerformerLoader) LoadThunk(key string) func() (*models.Performer, error) {
	l.mu.Lock()
...
func (l *PerformerLoader) LoadAll(keys []string) ([]*models.Performer, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *PerformerLoader) LoadAllThunk(keys []string) func() ([]*models.Performer, []error) {
	results := make([]func() (*models.Performer, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *PerformerLoader) Prime(key string, value *models.Performer) bool {
	l.mu.Lock()
	var found bool
...
func (l *PerformerLoader) Clear(key string) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *PerformerLoader) unsafeSet(key string, value *models.Performer) {
	if l.cache == nil {
		l.cache = map[string]*models.Performer{}
	}
	l.cache[key] = value
}
...
func (b *performerLoaderBatch) keyIndex(l *PerformerLoader, key string) int {
