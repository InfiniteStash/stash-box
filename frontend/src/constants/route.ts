...
export const ROUTE_CREDIT_ROLE = "/credit-roles/:id";
export const ROUTE_CREDIT_ROLE_ADD = "/credit-roles/add";
export const ROUTE_CREDIT_ROLE_EDIT = "/credit-roles/:id/edit";
export const ROUTE_CREDIT_ROLES = "/credit-roles";
