...
const PerformerInfo: React.FC<{performer: Performer}> = ({ performer }) => {
    ...
    const [
        deletePerformer,
        { loading: deleting }
    ] = useMutation<DeletePerformerMutation, DeletePerformerMutationVariables>(
                            ...
                            <Table striped className="performer-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Measurements</td>
                                        <td>
                                            { performer.measurements.cup_size && performer.measurements.band_size
                                    ...
                                    { (performer.gender === 'FEMALE' || performer.gender === 'TRANSGENDER_FEMALE') && (
                                        <tr>
                                            <td>Breast type</td>
