    ...
    <>
      ...
      <tr className={expanded ? "" : "d-none"}>
        <td colSpan={6} className="p-0 border-0">
          ...
          {audit.action === "EDIT_COMMENT_DELETE" && (
            <CommentDeleteAuditDetails data={audit.data} />
          )}
        </td>
      </tr>
    </>
